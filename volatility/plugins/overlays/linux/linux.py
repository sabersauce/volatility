...
def parse_system_map(data, module):
    ...
    for line in data.splitlines():
        (str_addr, symbol_type, symbol) = line.strip().split()[:3]
...
class module_struct(obj.CType):
    ...
    def is_valid(self):
        ...
        if self.state.v() in [0, 1, 2] and \
           self.core_size >= 128 and self.core_size <= 1000000 and \
           self.core_text_size >= 128 and self.core_text_size <= 1000000 and \
           self.module_core.v():
